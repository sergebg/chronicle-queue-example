...
public class TooManyOpenFilesTest {
    ...
    public void setUp() throws IOException {
        ...
        assumeThat(os.getName(), not(containsString("Windows")));
    ...
    public void test() throws IOException, InterruptedException {
        ...
        assertThat(leakCount, greaterThanOrEqualTo(targetLeakCount));
    ...
    private static void emulateApplicationLogic() {
        gc();
    }
